...
class wsm_Social_Widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id( 'wsm_twitter' ); ?>"><?php echo __( 'Twitter URL:', 'patricia'); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'wsm_twitter' ); ?>" name="<?php echo $this->get_field_name( 'wsm_twitter' ); ?>" value="<?php echo $instance['wsm_twitter']; ?>" /></label></p>

		<p><label for="<?php echo $this->get_field_id( 'wsm_facebook' ); ?>"><?php echo __( 'Facebook URL:', 'patricia'); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'wsm_facebook' ); ?>" name="<?php echo $this->get_field_name( 'wsm_facebook' ); ?>" value="<?php echo $instance['wsm_facebook']; ?>" /></label></p>

		<p><label for="<?php echo $this->get_field_id( 'wsm_googleplus' ); ?>"><?php echo __( 'Google+ URL:', 'patricia'); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'wsm_googleplus' ); ?>" name="<?php echo $this->get_field_name( 'wsm_googleplus' ); ?>" value="<?php echo $instance['wsm_googleplus']; ?>" /></label></p>

		<p><label for="<?php echo $this->get_field_id( 'wsm_pinterest' ); ?>"><?php echo __( 'Pinterest URL:', 'patricia'); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'wsm_pinterest' ); ?>" name="<?php echo $this->get_field_name( 'wsm_pinterest' ); ?>" value="<?php echo $instance['wsm_pinterest']; ?>" /></label></p>

		<p><label for="<?php echo $this->get_field_id( 'wsm_youtube' ); ?>"><?php echo __( 'Youtube URL:', 'patricia'); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'wsm_youtube' ); ?>" name="<?php echo $this->get_field_name( 'wsm_youtube' ); ?>" value="<?php echo $instance['wsm_youtube']; ?>" /></label></p>
